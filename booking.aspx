            ...
            <td height="125" align="center" valign="top" bgcolor="#F0F0F0">
                ...
                <tbody>
                  <tr><asp:Literal ID="uidLiteral" Visible="false" runat="server" />
                    <td align="left" valign="bottom" bgcolor="#FFECC9" style="font-family: '微軟正黑體'; font-size: 18px;">請確認您的訂房資訊</td>
                    </tr>
                  <tr>
                    <td align="left" valign="top">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><span style="font-family: '微軟正黑體'; font-size: 18px; color: #001FA0;"><asp:Literal ID="訂房日期Literal" runat="server" /></td>
                        </tr>
                        <tr>
                          <td>住房日期：</td>
                          <td><asp:TextBox ID="住房日期TextBox" MaxLength="10" runat="server" /></td>
                        </tr>
                        <tr>
                          <td>入住天數：</td>
                          <td><asp:TextBox ID="入住天數TextBox" MaxLength="5" runat="server" /></td>
                        </tr>
                        <tr>
                          <td>您選擇的旅店房型：</td>
                          <td>
                              <asp:DropDownList ID="旅店DropDownList" AutoPostBack="true" OnSelectedIndexChanged="On_Hotel_SelectedIndexChanged" runat="server"></asp:DropDownList>
                              <asp:DropDownList ID="房型DropDownList" AutoPostBack="true" OnSelectedIndexChanged="On_Room_SelectedIndexChanged" runat="server"></asp:DropDownList>
                          </td>
                        </tr>
                        <tr>
                          <td width="150">應付總金額：</td>
                          <td><span style="font-family: '微軟正黑體'; font-size: 18px; color: #001FA0;"><asp:Literal ID="金額Literal" runat="server" /></td>
                        </tr>
                        <tr>
                          <td>付款方式：</td>
                          <td>
                              <asp:DropDownList ID="付款方式DropDownList" runat="server">
                                  <asp:ListItem Text="現金" Value="現金" Selected="True"></asp:ListItem>
                                  <asp:ListItem Text="信用卡" Value="信用卡"></asp:ListItem>
                              </asp:DropDownList>
                          </td>
                        </tr>
                      </tbody>
                  ...
                  <tr>
                    <td align="left" valign="top" bgcolor="#FFECC9"><span style="font-family: '微軟正黑體'; font-size: 18px;">請填寫訂房人資訊</span></td>
                  </tr>
                  <tr>
                    <td height="130" align="left" valign="top">
                      ...
                      <tbody>
                        <tr>
                          <td width="100">你的 ID：</td>
                          <td><asp:TextBox ID="IDTextBox" MaxLength="50" runat="server" /> (查詢訂房時使用)</td>
                        </tr>
                        <tr>
                          <td>姓名：</td>
                          <td><asp:TextBox ID="姓名TextBox" MaxLength="50" runat="server" /></td>
                        </tr>
                        <tr>
                          <td>電話：</td>
                          <td><asp:TextBox ID="電話TextBox" MaxLength="50" runat="server" /></td>
                        </tr>
                        <tr>
                          <td>Email：</td>
                          <td><asp:TextBox ID="EmailTextBox" MaxLength="250" runat="server" /></td>
                        </tr>
                      </tbody>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td align="center" valign="top">
                        <asp:ImageButton ID="submitButton" OnCommand="On_ButtonClick" CommandName="Submit" ImageUrl="image/Group 86.png" runat="server" />
                    </td>
                  </tr>
                  </tbody>
                </table>

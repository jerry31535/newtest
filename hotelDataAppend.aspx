<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hotelDataAppend.aspx.cs" Inherits="hotelDataAppend" %>
        ...
        <tbody>
          ...
          <tr>
            <td height="125" align="center" valign="top" bgcolor="#F0F0F0">
                ...
                <tbody>
                  <tr>
                    <td align="left" valign="top" bgcolor="#FFECC9">新增旅店資料</td>
                  </tr>
                  <tr>
                    <td align="left" valign="top">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>名稱：</td>
                          <td><asp:TextBox ID="名稱TextBox" MaxLength="50" runat="server" /></td>
                        </tr>
                        <tr>
                          <td valign="top">描述：</td>
